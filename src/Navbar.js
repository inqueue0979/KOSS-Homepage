...
function Navbar()
{
  ...
  return (
    <nav className={`fixed top-0 z-50 w-full h-14 flex items-center justify-center backdrop-blur-md md:h-20`}>
      ...
      <div className='flex items-center justify-self-endfont-regular text-white min-w-40'>
        <ul className='flex justify-center items-center list-none gap-6'>
          <li className="hidden lg:flex">
              <Link to={"/#introduce"} className=" drop-shadow-md">소개</Link>
          </li>
          <li className="hidden lg:flex">
              <Link to={"/#activities"} className="drop-shadow-md">활동</Link>
          </li>
          <li className="hidden lg:flex">
              <Link to={"/#events"} className="drop-shadow-md">이벤트</Link>
          </li>
